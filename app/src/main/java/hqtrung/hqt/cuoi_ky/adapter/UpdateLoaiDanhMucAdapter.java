...
public class UpdateLoaiDanhMucAdapter extends RecyclerView.Adapter<UpdateLoaiDanhMucAdapter.ViewHolder> {
    private Context context;
    private ArrayList<LoaiDanhMuc> arrayList;

    public UpdateLoaiDanhMucAdapter(Context context, ArrayList<LoaiDanhMuc> arrayList) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.layout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ActivitySuaSanPham.edtLDM.setText(LDM.getName());
                UpdateDanhMucAdapter.dialog.dismiss();
            }
        });
    }
